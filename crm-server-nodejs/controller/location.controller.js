...
router.get("/state/:id", async (req, res) => {
    try {
        locationImpl
            .getStateByCountry({ countryId: req.params.id })
            .then((list) => {
                res.status(200).json(func.responseModel({ data: list }));
            })
            .catch((error) => {
...
router.get("/city/:id", async (req, res) => {
    try {
        locationImpl
            .getCityByState({ stateId: req.params.id })
            .then((list) => {
                res.status(200).json(func.responseModel({ data: list }));
            })
            .catch((error) => {
...
router.get("/state/name/:stateName", async (req, res) => {
    try {
        locationImpl
            .getStateByName({ stateName: req.params.stateName })
            .then((list) => {
                res.status(200).json(func.responseModel({ data: list }));
            })
            .catch((error) => {
...
router.get("/city/name/:cityName", async (req, res) => {
    try {
        locationImpl
            .getCityByName({ cityName: req.params.cityName })
            .then((list) => {
                res.status(200).json(func.responseModel({ data: list }));
            })
            .catch((error) => {
